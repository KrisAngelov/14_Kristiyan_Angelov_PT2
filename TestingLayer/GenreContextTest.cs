...
namespace TestingLayer
{
    ...
    public class GenreContextTest
    {
        ...
        public void ReadWithNavigationalProperties()
        {
            ...
            Assert.That(readGenre.Users.Contains(u), "U is not in the Users list!");
            Assert.That(readGenre.Games.Contains(g), "G is not in the Games list!");
        }
